...
namespace UnitTesting
{
    ...
    public class ReadDintTagTest
    {
        ...
        public async Task ReadAnyIntTag()
        {
            ...
            await ReadDintTag("DINT", "NicksTestTag", null, null, null);
        }

        public async Task ReadDintTag(string dataType, string tagName, int? valueIndex, int? arrayIndex, int? arrayDimensions)
        {
            ...
            bool value;
            value = await DintTag.ReadTagBoolValue(DintTag);
